    ...
    <section className="bg-black pb-52">
        <div className="container mx-auto px-3 md:px-10">
            ...
            overflow-hidden rounded-md: md:h-[65vh]">
                ...
                activities across Web2 and Web3 games into a rewarding aventure."
                isComingSoon={true}
                />
            </BentoTilt>
                ...
                <div className="bento-tilt_2">
                    <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                        <h1 className="bento-title special-font max-w-64 text-black">
                            M<b>o</b>re co<b>m</b>in<b>g</b> so<b>o</b>n!
                        </h1>
                        <TiLocationArrow className="m-5 scale-[5] self-end"/>
                    </div>
                </div>
                <div className="bento-tilt_2">
                    <video src="videos/feature-5.mp4" loop muted autoPlay className="size-full
