...
function Contact() {
  return (
    ...
    text-blue-50 sm:overflow-hidden max-sm:items-center">
      <div className="absolute -left-20 top-0 hidden 
      h-full w-72 overflow-hidden sm:block lg:left-20 lg:w-96">
        <ImageClipBox
      ...
      sm:top-1/2 md:left-auto md:right-10 lg:top-20 lg:w-80 ">
        ...
        <ImageClipBox
          ...
          clipClass="sword-man-clip-path md:scale-125 self-center"
        />
      </div>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <AnimatedTitle
          ...
          className="special-font !text-white-50 
          !md:text-[6.2rem] w-full font-zentry !text-5xl 
